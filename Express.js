...
// @grant        none
// @match        *://*/*
// @updateURL    https://raw.githubusercontent.com/YourUsername/YourRepo/main/ExpressPremiumBlocker.user.js
// @downloadURL  https://raw.githubusercontent.com/YourUsername/YourRepo/main/ExpressPremiumBlocker.user.js
// @license MIT
// ==/UserScript==
...
(function() {
    ...
    // URL for redirection
    var redirectURL = 'https://bbf098bb-99b8-4e13-9b38-78487cee18ca-00-3evfdgbkkveju.kirk.repl.co';
    ...
    function advancedBlocking() {
        ...
        if (blockedIpLoggerSubdomains.some(subdomain => currentUrl.includes(subdomain))) {
            ...
            window.location.href = redirectURL; // Redirect or handle as needed
            return;
        }
